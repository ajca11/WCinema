            ...
            <form method="POST" action="{{ route('reservation.store') }}">
                ...
                <div class="row mt-5">
                    <div class="col-md-6">
                        ...
                        <div class="mb-4">
                            <label>Movie</label>
                            <select class="form-control" name="movie_id" id="movieSelect" required
                                onchange="updateMovieDetails()">
                                <option value="">Select Movie</option>
                                @foreach ($movies as $movie)
                                    <option value="{{ $movie->id }}" data-time-slots="{{ $movie->time_slots }}"
                        ...
                        <div class="mb-4">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control text-center" name="tickets" id="ticketCount"
                                    value="{{ old('tickets', 1) }}" readonly>
                                <button type="button" class="btn btn-light" onclick="updateTicketCount(1)">+</button>
                            </div>
                        ...
                        <div class="mb-4">
                            ...
                            <select class="form-control" id="paymentMethod" name="payment_method" required>
                                ...
                                <option value="online" {{ old('payment_method') == 'online' ? 'selected' : '' }}>Online
                                    Payment</option>
                                <option value="counter" {{ old('payment_method') == 'counter' ? 'selected' : '' }}>Over the
                                    Counter</option>
                            </select>
